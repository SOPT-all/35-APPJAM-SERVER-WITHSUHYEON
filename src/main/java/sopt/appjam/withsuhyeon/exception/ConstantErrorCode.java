...
public enum ConstantErrorCode implements ErrorCode {
    ...
    NOT_FOUND_PROFILE_IMAGE(HttpStatus.BAD_REQUEST, "CATEGORY_002","유효하지 않은 프로필 이미지 입니다."),
    NOT_FOUND_LOCATION_FROM_SUBLOCATION(HttpStatus.BAD_REQUEST, "CATEGORY_003","해당 하위지역에 해당하는 상위지역을 찾을 수 없습니다.");
