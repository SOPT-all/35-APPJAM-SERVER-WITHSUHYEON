...
public enum PostErrorCode implements ErrorCode {
    ...
    POST_REGION_INVALID_INPUT(HttpStatus.BAD_REQUEST, "POST_003", "유효하지 않는 관심 지역을 입력하였습니다."),
    POST_REQUEST_INVALID_INPUT(HttpStatus.BAD_REQUEST, "POST_004", "유효하지 않는 요청 사항을 입력하였습니다.");
